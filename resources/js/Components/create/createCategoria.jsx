...
const Categorias = ({ onSubmit }) => {
  ...
  useEffect(() => {
    const fetchMarcas = async () => {
      try {
        const response = await axios.get('https://equipamientoindustriales.hpservidor.com/marca/all');
  ...
  const handleDeleteCategoria = async (id, nombre) => {
    ...
    try {
      ...
      await axios.delete(`https://equipamientoindustriales.hpservidor.com/categoria/delete/${id}`, config);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://equipamientoindustriales.hpservidor.com/categoria/create', formData, config);
