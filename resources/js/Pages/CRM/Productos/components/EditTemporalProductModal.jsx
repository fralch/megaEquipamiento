...
export default function EditTemporalProductModal({ isOpen, onClose, onSave, producto }) {
    ...
    const loadProductoData = () => {
        ...
        // Convertir especificaciones de objeto a array
        const especificaciones = producto.especificaciones_tecnicas
            ? Object.entries(producto.especificaciones_tecnicas).map(([clave, valor]) => ({ clave, valor }))
            : [{ clave: '', valor: '' }];
        ...
        setFormData({
            ...
            especificaciones_tecnicas: especificaciones.length > 0 ? especificaciones : [{ clave: '', valor: '' }],
