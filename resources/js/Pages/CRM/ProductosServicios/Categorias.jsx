...
export default function Categorias() {
    ...
    const categorias = [
        { id: 1, nombre: "Equipamiento Industrial", descripcion: "Maquinaria y equipos para industria", productos: 25, estado: "Activo" },
        { id: 2, nombre: "Herramientas", descripcion: "Herramientas manuales y eléctricas", productos: 45, estado: "Activo" },
        { id: 3, nombre: "Motores y Bombas", descripcion: "Motores eléctricos y sistemas de bombeo", productos: 18, estado: "Activo" },
        { id: 4, nombre: "Sistemas Eléctricos", descripcion: "Componentes y sistemas eléctricos", productos: 32, estado: "Activo" },
        { id: 5, nombre: "Mantenimiento", descripcion: "Productos para mantenimiento industrial", productos: 15, estado: "Inactivo" }
    ];
