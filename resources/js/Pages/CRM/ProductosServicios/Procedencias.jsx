...
export default function Procedencias() {
    ...
    const procedencias = [
        { id: 1, pais: "Alemania", productos: 45, estado: "Activo" },
        { id: 2, pais: "Estados Unidos", productos: 32, estado: "Activo" },
        { id: 3, pais: "China", productos: 28, estado: "Activo" },
        { id: 4, pais: "Japón", productos: 15, estado: "Activo" },
        { id: 5, pais: "Italia", productos: 12, estado: "Inactivo" }
    ];
                    ...
                    <nav className="p-4">
                        <div className="space-y-2">
                            <div className={`flex items-center gap-3 px-4 py-3 rounded-xl ${
                                ...
                                <span className="font-medium text-sm">Procedencias</span>
                            </div>
                        </div>
                    </nav>
                </aside>
